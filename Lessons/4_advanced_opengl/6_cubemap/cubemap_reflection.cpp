...
int main(){
    ...
    {
        (root / "../../../textures/skybox/right.jpg").string(),
        (root / "../../../textures/skybox/left.jpg").string(),
        (root / "../../../textures/skybox/top.jpg").string(),
        (root / "../../../textures/skybox/bottom.jpg").string(),
        (root / "../../../textures/skybox/front.jpg").string(),
        (root / "../../../textures/skybox/back.jpg").string()
    };
